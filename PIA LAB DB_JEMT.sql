...
INSERT INTO [dbo].[TipoPastas]
           ...
           ,[Nombre_p])
     VALUES
           (1,'Cuero'),(2,'Dura'),(3,'Estándar'),(4,'Encartonada'),(5,'Tapa suelta'),(6,'Cartoné');

INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(1,'En busca del tiempo perdido',9,4,4,1,3),(2,'Cuentos',17,6,1,2,4),(3,'Poeta en Nueva York',11,2,1,2,3),(4,'El viejo y el mar',15,4,4,1,2),(5,'Grandes esperanzas',9,9,1,2,5),(6,'Las metamorfosis',10,3,2,1,3),(7,'Casa de muñecas',2,5,1,1,2),(8,'Confesiones de una máscara',7,9,3,2,2),(9,'Al faro',11,10,4,2,3),(10,'Matar a un ruiseñor',12,9,4,1,2);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(11,'La guerra del fin del mundo',11,3,3,2,4),(12,'Los miserables',15,9,2,1,3),(13,'Fausto',10,5,1,1,2),(14,'Libro del desasosiego',16,9,2,2,4),(15,'La muerte de Artemio CruzFahrenheit 451',2,3,3,1,3),(16,'1984',19,4,3,2,4),(17,'Si esto es un hombre',17,6,3,2,2),(18,'El tambor de hojalata',16,9,2,1,2),(19,'Si esto es un hombre',3,3,3,2,5),(20,'Poesías',16,1,3,1,1);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(21,'Historia y decadencia del Imperio',2,10,2,2,4),(22,'Madame Bovary',1,1,4,1,5),(23,'Historia y decadencia del Imperio',15,8,2,2,3),(24,'La isla del tesoro',5,7,4,2,4),(25,'El Tartufo',14,5,2,1,3),(26,'Moby Dick',9,9,4,2,6),(27,'Canto general',11,8,3,2,1),(28,'El señor de las moscas',8,8,3,2,1),(29,'Rojo y negro',6,5,2,2,4),(30,'Ensayo sobre la ceguera',10,3,4,2,6);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(31,'Orgullo y prejuicio',19,9,2,2,2),(32,'El túnel',20,2,1,2,3),(33,'El viejo y el mar',17,1,2,1,6),(34,'Cuentos',16,7,3,2,3),(35,'Crimen y castigo',5,9,3,1,1),(36,'La muerte de Artemio CruzFahrenheit 451',11,4,4,1,6),(37,'Poeta en Nueva York',17,4,4,1,5),(38,'Drácula',9,4,1,1,4),(39,'Drácula',1,4,3,1,2),(40,'El guardián entre el centeno',4,5,1,1,6);
...
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(51,'Al faro',5,4,2,1,5),(52,'La isla del tesoro',17,10,2,2,1),(53,'Drácula',9,3,1,1,1),(54,'La odisea',8,5,4,2,1),(55,'Confesiones de una máscara',3,9,3,1,1),(56,'Historia y decadencia del Imperio',8,7,4,2,5),(57,'Drácula',17,7,4,2,6),(58,'Orgullo y prejuicio',7,2,1,2,4),(59,'Matar a un ruiseñor',4,10,1,1,4),(60,'Un mundo feliz',13,5,2,1,5);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(61,'El extranjero',7,1,1,2,5),(62,'Matar a un ruiseñor',18,10,1,1,6),(63,'Hamlet',17,7,3,1,6),(64,'Las mil y una noches',2,1,2,1,1),(65,'Lo que el viento se llevó',11,7,3,2,5),(66,'El guardián entre el centeno',13,10,3,2,3),(67,'Kim',9,8,2,1,3),(68,'Kim',17,5,4,1,4),(69,'Estudio en escarlata',4,9,2,2,5),(70,'La insoportable levedad del ser',5,2,2,1,3);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(71,'El extranjero',2,2,3,1,1),(72,'Casa de muñecas',13,4,2,2,2),(73,'Si esto es un hombre',20,3,3,2,6),(74,'La insoportable levedad del ser',17,2,1,2,5),(75,'Ensayo sobre la ceguera',20,5,3,2,1),(76,'Rayuela',6,3,4,2,1),(77,'Las aventuras de Huckelberry Finn',1,4,2,2,6),(78,'La comedia humana',18,1,2,2,5),(79,'Olvidado rey Gudú',12,10,1,1,3),(80,'Luces de bohemia',19,9,1,2,4);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(81,'Los viajes de Gulliver',4,7,4,1,3),(82,'Las uvas de la ira',2,8,3,2,4),(83,'El conde de Montecristo',16,9,1,1,6),(84,'El tambor de hojalata',4,7,3,2,6),(85,'Drácula',20,6,4,1,3),(86,'La odisea',13,8,1,2,6),(87,'La insoportable levedad del ser',18,3,3,1,4),(88,'Las metamorfosis',5,5,2,1,6),(89,'Las metamorfosis',15,6,4,1,2),(90,'Las aventuras de Huckelberry Finn',8,3,2,2,3);
INSERT INTO dbo.Libro([Libro_id],[Titulo],[Autor_id2],[Genero_id2],[Edicion],[Pasta_id2],[Editorial_id2]) VALUES(91,'Don Quijote de la mancha',10,5,1,2,4),(92,'Los miserables',3,5,3,2,3),(93,'Los miserables',6,2,3,1,5),(94,'Si esto es un hombre',10,2,1,1,6),(95,'100 años de Soledad',4,8,2,1,6),(96,'Orgullo y prejuicio',2,5,1,2,5),(97,'Príncipes de Maine',13,7,2,2,2),(98,'Ddoña Perfecta',9,6,2,2,4),(99,'La metamorfosis',3,6,4,2,3),(100,'Poesías completas',18,10,4,1,6);
...
INSERT [dbo].[Editoriales] ([Editorial_id], [Nombre_ed]) VALUES (6, 'Plaza y Janés')
